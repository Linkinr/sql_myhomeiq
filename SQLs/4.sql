SELECT company_id FROM users INNER JOIN reservations ON reservations.status = 2 
...
AND (customer_details.monthly_digest_sent_date IS NULL AND reservations.setup_subscription_at <= '2025-03-09 12:00:00' OR customer_details.monthly_digest_sent_date IS NOT NULL AND customer_details.monthly_digest_sent_date <= '2025-03-09')